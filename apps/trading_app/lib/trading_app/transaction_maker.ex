defmodule TradingApp.TransactionMaker do
  use GenServer
  require Logger

  alias TradingApp.{Transactions, TransactionSlots, NumberFormatter}
  ...
  ## Examples
      ...
      {:ok, pid} = TradingApp.TransactionMaker.start_link()
  ...
  ## Examples
      ...
      iex> TradingApp.TransactionMaker.make_buy("BTCFDUSD", 10.42416, 1)
      {:ok, :transaction_done}

      iex> TradingApp.TransactionMaker.make_buy("notexistingsymbol", 10.42416, 1)
  ...
  ## Examples
      ...
      iex> TradingApp.TransactionMaker.make_sell(transaction)
      {:ok, :transaction_done}
